...
# Firm B Comparison
st.sidebar.subheader("🤝 2. Comparison (Firm B)")
    ...
    st.markdown("""
        <div class="welcome-card">
            ...
            <p style='font-size: 1.1em; color: #555;'>
                Select one or two companies from the sidebar to begin. 
                We will analyze the correlation between Net Income and Operating Cash Flow 
                to evaluate the "Earnings Quality" and financial sustainability of the chosen firms.
            </p>
        </div>
    """, unsafe_allow_html=True)
    ...
    if data_a.empty:
        ...
        with tabs[2]:
            ...
            def get_highlight(x):
                ...
                if x == ticker_b: return 'Firm B (Compare)'
